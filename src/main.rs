...
fn main() {
    let circuit_filepath = format!("circuit_files/nova_1.r1cs");
    let witness_gen_filepath = format!("circuit_files/nova_1.wasm");

    run_test(circuit_filepath, witness_gen_filepath);
}
